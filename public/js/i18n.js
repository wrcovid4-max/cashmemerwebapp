...
const STRINGS = {
  en: {
    ...
    tax: 'Tax',
    taxOnAfterDiscount: 'Tax is charged on the amount after the discount. Change this in Settings → Tax.',
    taxOnBeforeDiscount: 'Tax is charged on the full price, before the discount. Change this in Settings → Tax.',
  ...
  ur: {
    ...
    tax: 'ٹیکس',
    taxOnAfterDiscount: 'ٹیکس رعایت کے بعد رقم پر لاگو ہوتا ہے۔ اسے ترتیبات → ٹیکس میں تبدیل کریں۔',
    taxOnBeforeDiscount: 'ٹیکس رعایت سے پہلے پوری قیمت پر لاگو ہوتا ہے۔ اسے ترتیبات → ٹیکس میں تبدیل کریں۔',
    grandTotal: 'کل میزان',
